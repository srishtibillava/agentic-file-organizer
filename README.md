...
**planner → inspector → executor → self_heal**

### Human-in-the-Loop Safety

Scans for **high-risk operations** (e.g., file deletion) and prompts for explicit user approval (**yes/no**).

### Real File Operations

Directly interacts with your local disk using Python's **os** and **shutil**.

### Self-Healing Loop

Gracefully recovers from errors or rejected permissions by re-planning alternative steps without crashing.

### 100% Local & Free

Powered locally by **Qwen 2.5 via Ollama** with zero API latency or data exposure.
...
Create directory: 'Projects/Organized'

Move file: 'report.pdf' -> 'Projects/Organized/report.pdf'

Delete file: 'Projects/temp.txt'
